...
var secondTime = 0;
clacSenend = setInterval(function () {
  secondTime += 1;
}, 1000);
function ST() {}
...
player.src = "./images2/playerD1.png";
arms.src = "./images2/arms4.png";
arms.style.animation = "arms2 .5s linear";
touchH1.addEventListener("click", run);
touchH1.addEventListener("click", function () {
...
function disappear() {
  ...
  player.src = "./images2/playerD2.png";
...
bingo[bingo.length - 1].addEventListener("click", function () {
